...
const CRMDevelopment = () => {
  ...
  return (
    ...
    <Helmet>
        <title>
        CRM Development Service Provider | Kasper Infotech
        </title>
        <meta
          name="discription"
          content="Our company offers powerful CRM solutions that simplify customer interactions, automate sales processes, and improve overall customer satisfaction"
        />
        <meta name="keywords" content="CRM Development Service" />
      </Helmet>
      <MainHeader background={background} mainheading="Business Success with Advanced CRM Development Services" subHeading="Kasper InfoTech offers development services in India's top CRM (Customer Relationship Management). We specialize in developing customized CRM solutions that assign businesses to simplify customer interactions, enhance productivity." />
      <ServiceMainSection
