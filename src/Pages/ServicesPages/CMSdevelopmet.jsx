...
const CMSdevelopmet = () => {
  ...
  return (
    <>
     <Helmet>
        <title>
        Top CMS website development | Kasper Infotech
        </title>
        <meta
          name="discription"
          content="Kasper Infotech is a renowned company that specializes in creating CMS websites in India, showcasing their expertise in the field."
        />
        <meta name="keywords" content="CMS Development Service" />
      </Helmet>
      <MainHeader background={background} mainheading="CMS Development Company" subHeading="Kasper Infotech is a renowned CMS Development Company known for its CMS web development services expertise. Our dedicated team of Craft CMS developers excels in crafting custom CMS solutions tailored to your specific requirements. We take pride in delivering top-quality CMS development services you can trust." />
      <ServiceMainSection
        highlights="OUR SERVICES"
        highlightsDouble="SERVICES"
        heading="Our company offers various CMS development services at Kasper Infotech Company to meet your requirements. Our expert team of developers and designers are experienced in multiple CMS platforms, including but not limited to Word Press, Drupal, Joomla, Magneto and custom-built CMS solutions."
      />
      <div className="row container m-auto HideServiceList">
        <TwoPartGridLeft
          title="Custom CMS Development"
          Discription="We understand that every business has unique needs. We specialize in creating tailor-made CMS solutions that align perfectly with your objectives. Our custom CMS solutions are made from the ground up to suit your specific content management and business requirements."
        ...
        <TwoPartGridRight
          ...
          Discription="With our Plugin and Module Development services, experience smooth CMS development. To improve the operation of your website and satisfy your particular business requirements, we specialize in developing custom extensions."
          ImageHandle={Plugins}
        />
        <TwoPartGridLeft
          title="Migration Services"
          Discription="Suppose you want to migrate from one CMS platform to another or upgrade to the latest version. In that case, we have the expertise to make the process easy and efficient, ensuring that your data and content remain unchanged."
      ...
      <div className="row container mt-3 m-auto HideServiceList">
        <TwoPartGridLeft
          ...
          Discription="A CMS makes it easy for you to create, edit and organize content on your website. It allows non-technical users to update content easily and reduces dependence on web developers or IT teams. This agility is crucial to keeping your website fresh and engaging.."
        ...
        <TwoPartGridLeft
          ...
          Discription="Content is everything in the digital world or a CMS can help you create SEO-optimized content. You can easily add Meta tags, keywords and alt text to your images to increase your site's visibility in search engines. Greater visibility can lead to more organic traffic and higher conversion rates."
          ImageHandle={FriendlyContent}
        />
        <TwoPartGridRight
          title="Efficient Collaboration"
          Discription="CMS simplifies collaboration for companies with multiple content contributors or remote teams. It allows team members to work on content while tracking changes and maintaining version control. Promote efficient teamwork and reduce errors."
          ImageHandle={Collaboration}
        />
        <TwoPartGridLeft
          title="Scalability"
          Discription="As your business grows, your website's content needs will evolve. A CMS can adapt to your changing requirements. Whether you need to add new pages, products or blog posts a CMS offers scalability without requiring a complete website overhaul."
        ...
        <TwoPartGridRight
          ...
          Discription="In the long run, a CMS can save you money. It reduces the need for continuous web development support as non-technical staff can manage content updates. Additionally, quickly making changes can save you from costly errors or outdated information."
      ...
      <div className="Tech-images container mb-5 m-auto">
        ...
        <img title="Site Core" style={{width:"80px", height:"60px"}} src={SiteCoreCMS} alt="" />
        <img title="Webflow" style={{width:"80px", height:"60px"}} src={Webflow} alt="" />
        <img title="Megneto" style={{width:"80px", height:"60px"}} src={Megneto} alt="" />
        <img title="Wordpress" style={{width:"80px", height:"60px"}} src={Wordpress} alt="" />
        <img title="Drupal" style={{width:"80px", height:"60px"}} src={Drupal} alt="" />
        <img title="Shopify" style={{width:"80px", height:"60px"}} src={Shopyfi} alt="" />
        <img title="GHOST" style={{width:"80px", height:"60px"}} src={GHOSTCMS} alt="" />
        <img title="CMS Hub" style={{width:"80px", height:"60px"}} src={CMSHUB} alt="" />
        <img title="Joomla" style={{width:"80px", height:"60px"}} src={Joomla} alt="" />
        </div>
      </div>
      </>
  );
